...
exports.modifySauce = (req, res, next) => {
    // Récupération de la sauce en base de données
    Sauce.findOne({ _id: req.params.id })
        ...
        .then((sauce) => {
            ...
            // on utilise "?" pour savoir si un fichier image a été ajouté à la requête
            ...
            // si les userId ne correspondent pas, on envoi une erreur 403 unauthorized
                ...
                res.status(403).json({ error: "vous n'êtes pas autorisé à modifier cette sauce" });
            }
        })
...
// Visualisation d'une sauce par son id 
